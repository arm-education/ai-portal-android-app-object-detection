...
def main() -> None:
    parser = argparse.ArgumentParser(
        description="Check files produced for a generated Android detection adapter."
    )
    ...
    source_directory = project_root / (
        "app/src/main/java/org/arm/learningpath/objectdetection"
    )
    ...
    if adapter.is_file():
        ...
        if "implements DetectionAdapter" not in adapter_source:
            errors.append("The generated class must implement DetectionAdapter")
